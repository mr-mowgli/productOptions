...
const ProductOptions = () => {
  ...
  const getProduct = async (productId) => {
    const response = await axios.get(`http://${location.hostname}:3002/products/${productId}`);
  ...
  const getStore = async (storeId) => {
    const response = await axios.get(`http://${location.hostname}:3002/stores/${storeId}`);
  ...
  const getStock = async (productId) => {
    const response = await axios.get(`http://${location.hostname}:3002/stock/${productId}`);
